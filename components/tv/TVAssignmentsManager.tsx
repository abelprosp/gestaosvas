...
import { AssignTVSlotPayload, UpdateTVSlotPayload } from "@/lib/api/tv";
...
export function TVAssignmentsManager({ clientId, isTvSelected, isOpen }: TVAssignmentsManagerProps) {
  ...
  // Se não tem clientId (criando cliente novo), não mostrar nada aqui
  // O formulário de criação está no ClientFormModal
  if (!clientId) {
    return null;
  }
